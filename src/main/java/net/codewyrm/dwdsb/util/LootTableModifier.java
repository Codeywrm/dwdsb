    ...
    public static void modifyLootTables() {
        LootTableEvents.MODIFY.register((key, tableBuilder, source, registries) -> {
            ...
            if (DESERT_PYRAMID_ID.equals(id)) {
                ...
                addToLootTable(tableBuilder, 2, DISC_CORE, .1f);
            }
            if (END_CITY_ID.equals(id)) {
                addToLootTable(tableBuilder, 1, REST, .1f);
                addToLootTable(tableBuilder, 3, DISC_CORE, .15f);
            }
            ...
            if (ABANDONED_MINESHAFT_ID.equals(id)) {
                ...
                addToLootTable(tableBuilder, 1, DISC_CORE, .1f);
            }
...
// Adds items to Sus blocks.
            ...
            if (LootTables.SNIFFER_DIGGING_GAMEPLAY.equals(key)) {
                tableBuilder.pool(LootPool.builder()
                        ...
                        .conditionally(RandomChanceLootCondition.builder(.001f))
                        .with(ItemEntry.builder(DISC_CORE))
                        .build()
                );
            }
        });
